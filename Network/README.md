...
The networking infrastructure follows AWS best practices for production-grade, secure, and highly available applications:

- Isolated VPC with private and public subnets
- Multi-AZ deployment across us-east-1a and us-east-1b
- Private application tier with no public exposure
- Secure connectivity via VPC endpoints
- Outbound internet access via NAT Gateway
- Inbound traffic via Application Load Balancer
